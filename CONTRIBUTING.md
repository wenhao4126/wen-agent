# Contributing to Wenhao

Thank you for your interest in contributing to Wenhao! This guide covers
...
```bash
git clone https://github.com/esengine/DeepSeek-Wenhao.git
cd DeepSeek-Wenhao
go build ./cmd/wenhao    # builds the CLI binary
...
| `internal/memory` | WENHAO.md hierarchy + auto-memory |
