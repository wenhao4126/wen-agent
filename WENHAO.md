...
agent. It is the Wenhao analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `WENHAO.md` (this file, committed/shared), `WENHAO.local.md`
  (personal, git-ignored), user-global `~/.config/wenhao/WENHAO.md`, and any
  `WENHAO.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
