...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — Wenhao end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "wenhao", "path to the wenhao binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 Wenhao e2e benchmark\n\n")
