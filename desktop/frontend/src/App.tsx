...
const SIDEBAR_COLLAPSED_KEY = "wenhao.sidebar.collapsed";
...
function sessionItemsToMarkdown(title: string, items: Item[], live?: LiveStream): string {
  const lines: string[] = [`# ${title.trim() || "Wenhao session"}`, ""];
    ...
    <div className="app">
      ...
      >
        <header className="app-chrome">
          ...
          <div className="app-chrome__identity" aria-label="Wenhao">
