...
const STORAGE_KEY = "wenhao.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["wenhao.sidebar.width"],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["wenhao.workspaceTree.width"],
  composerHeight: ["wenhao.composerHeight"],
  drawerWidth: ["wenhao.drawer.width"],
  settingsDrawerWidth: ["wenhao.settingsDrawer.width"],
};
