...
export const en = {
  ...
  "sidebar.navigation": "Wenhao navigation",
  ...
  // composer
  "composer.placeholder": "Message Wenhao…  ( / commands · @ files )",
  ...
  "memory.noDocs": "No WENHAO.md found. Quick-add one above.",
  ...
  "settings.closeBehavior.quit": "Quit Wenhao",
  ...
  "onboarding.title": "Connect Wenhao",
  ...
  // crash page
  "crash.title": "Wenhao hit an error — screenshot this and send it over",
  "crash.copy": "Copy",
  ...
  "mock.askQ2Header": "Wenhao build",
  "mock.askQ2Prompt": "What do you want to do about the missing wenhao binary?",
  ...
  "mock.changedFile2Path": ".wenhao/project.md",
};
