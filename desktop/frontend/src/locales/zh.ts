...
export const zh: Record<DictKey, string> = {
  ...
  // 输入框
  "composer.placeholder": "给 Wenhao 发消息…  ( / 命令 · @ 文件 )",
  ...
  "memory.noDocs": "未找到 WENHAO.md。可在上方快速添加一条。",
  ...
  "settings.closeBehavior.quit": "退出 Wenhao",
  ...
  "mock.askQ2Header": "Wenhao 构建",
  "mock.askQ2Prompt": "对于 wenhao 二进制缺失的问题，你想怎么做？",
