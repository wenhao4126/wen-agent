// Command wenhao-desktop is the Wails shell around the Wenhao kernel: a native
...
// a nested module (wenhao/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/wenhao does — boot.Build resolves providers/tools from these registries.
...
// mirroring cmd/wenhao/main.go. The auto-updater reads it (App.Version) to compare
