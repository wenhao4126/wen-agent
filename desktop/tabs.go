...
// workspace root is the wenhao user config directory.
...
func desktopConfigDir() string {
	...
	if err != nil {
		...
		return filepath.Join(home, ".wenhao")
	}
...
func topicTitlesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".wenhao", topicTitlesFile)
}
...
func topicTitleSourcesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".wenhao", topicTitleSourcesFile)
}
...
func globalWorkspaceRoot() string {
	...
	if err != nil {
		home, _ := os.UserHomeDir()
		return filepath.Join(home, ".wenhao", "global-workspace")
	}
	return filepath.Join(dir, "wenhao", "global-workspace")
}
