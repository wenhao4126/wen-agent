...
func (a *App) startTray() {
	...
	t.end = startDesktopTray(func() {
		...
		systray.SetTitle("Wenhao")
		systray.SetTooltip("Wenhao")
...
func trayMenuLabels(locale string) trayLabels {
	if locale == "zh" {
		return trayLabels{
			openTitle:   "打开",
			openTooltip: "打开 Wenhao 窗口",
			quitTitle:   "退出",
			quitTooltip: "退出 Wenhao",
		}
	}
	return trayLabels{
		openTitle:   "Open",
		openTooltip: "Open the Wenhao window",
		quitTitle:   "Quit",
		quitTooltip: "Quit Wenhao",
	}
}
