...
// than shipped in the wenhao binary, which keeps installs small. Resolve finds
...
// BundleDirName is the directory, beside the wenhao executable, that the release
...
//  4. a bundle placed beside the wenhao executable (fallback for manual setups).
//
...
// bundled looks for the CodeGraph launcher unpacked beside the wenhao binary.
