...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "WENHAO_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "WENHAO_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "WENHAO_TEST_MISSING"}, false},
