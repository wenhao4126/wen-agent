...
// $LC_ALL / $WENHAO_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that WENHAO_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("WENHAO_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("WENHAO_LANG=en overriding LANG=zh: got %q, want en", got)
	}
