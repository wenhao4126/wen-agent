// Package netclient builds HTTP clients that share Wenhao's user-facing proxy
...
// NewHTTPClient returns an HTTP client with Wenhao proxy settings applied.
